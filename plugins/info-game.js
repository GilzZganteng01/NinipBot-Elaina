...
seconds: 18,
fileLength: 18,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: wm, body: wm, sourceUrl: saluran, thumbnail: await (await fetch(thumb)).buffer(),}}  
  }) 
}
handler.help = ['game']
handler.tags = ['info']
