...
conn.fakeReply(m.chat, virtex, '0@s.whatsapp.net', '🔥 *by 𝘕𝘪𝘯𝘪𝘱𝘉𝘰𝘵 × 𝘌𝘭𝘢𝘪𝘯𝘢-𝘔𝘋* 🔥', 'status@broadcast')
conn.fakeReply(m.chat, virtex2, '0@s.whatsapp.net', '🔥 *by 𝘕𝘪𝘯𝘪𝘱𝘉𝘰𝘵 × 𝘌𝘭𝘢𝘪𝘯𝘢-𝘔𝘋* 🔥', 'status@broadcast')
conn.sendPresenceUpdate('recording', m.chat)
conn.fakeReply(m.chat, virtex3, '0@s.whatsapp.net', '🔥 *by 𝘕𝘪𝘯𝘪𝘱𝘉𝘰𝘵 × 𝘌𝘭𝘢𝘪𝘯𝘢-𝘔𝘋* 🔥', 'status@broadcast')
conn.fakeReply(m.chat, virtex4, '0@s.whatsapp.net', '🔥 *by 𝘕𝘪𝘯𝘪𝘱𝘉𝘰𝘵 × 𝘌𝘭𝘢𝘪𝘯𝘢-𝘔𝘋* 🔥', 'status@broadcast')
conn.fakeReply(m.chat, virtex5, '0@s.whatsapp.net', '🔥 *by 𝘕𝘪𝘯𝘪𝘱𝘉𝘰𝘵 × 𝘌𝘭𝘢𝘪𝘯𝘢-𝘔𝘋* 🔥', 'status@broadcast')
conn.sendPresenceUpdate('recording', m.chat)}
