...
mediaType:  2,
mediaUrl: 'https://www.instagram.com/nip.niff',
title: '「 ɢ ʀ ᴏ ᴜ ᴘ  ɴ ᴏ ᴛ ɪ ғ ɪ ᴄ ᴀ ᴛ ɪ ᴏ ɴ s 」',
body: '🍂 𝘕𝘪𝘯𝘪𝘱𝘉𝘰𝘵 × 𝘌𝘭𝘢𝘪𝘯𝘢-𝘔𝘋 🍂',
sourceUrl: 'https://www.instagram.com/nip.niff', thumbnail: await( await this.getFile(pp)).data
  }
 }})
                    }
                }
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'Maaf, Anda Tidak Berhak Menggunakan Fitur Ini, (Kamu Bukan Owner Utama)',
        owner: 'Maaf, Anda Tidak Berhak Menggunakan Fitur Ini, (Kamu Bukan Owner Bot)',
        mods: 'Maaf, Anda Tidak Berhak Menggunakan Fitur Ini, (Kamu Bukan Moderator)',
        premium: 'Maaf, Anda Tidak Berhak Menggunakan Fitur Ini, (Kamu Bukan Member Premium)',
        group: 'Maaf, Anda Tidak Berhak Menggunakan Fitur Ini, (Group Only)',
        private: 'Maaf, Anda Tidak Berhak Menggunakan Fitur Ini, (Private Only)',
        admin: 'Maaf, Anda Tidak Berhak Menggunakan Fitur Ini, (Hanya untuk Admin Grup)',
        botAdmin: 'Bot Bukan Admin, Jadikan Bot Admin Dulu!',
        unreg: 'Silahkan daftar untuk menggunakan fitur ini dengan cara mengetik:\n\n*.register nama.umur*\n\nContoh: *.register Ninip.19*',
